...
--- @field on_return_callback fun(): nil Function to be called when the user selects "Back to chapter list".
...
function MangaReader:applyReaderPreferences()
  ...
  local page_turn_style = G_reader_settings:readSetting("rakuyomi_page_turn_style", "paginated")
  pcall(function()
    UIManager:broadcastEvent(Event:new("SetScrollMode", page_turn_style == "scroll"))
  end)

  local reading_direction = G_reader_settings:readSetting("rakuyomi_reading_direction", "ltr")
  pcall(function()
